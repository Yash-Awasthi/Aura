...
- **TOFU first-meet gap:** On the very first exchange between two devices, a proximity MITM could substitute their own identity key. The `SasVerifier` 6-digit SAS display is the mitigation; fully integrated since v4.0.0. See [docs/SECURITY.md §6](docs/SECURITY.md).
